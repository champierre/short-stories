  ...
  if (container) {
    ...
    shareDiv.innerHTML =
      ...
      '<div class="share-buttons-list">' +
        '<a class="share-btn share-btn--x" href="https://x.com/intent/tweet?url=' + pageUrl + '&text=' + pageTitle + '" target="_blank" rel="noopener" aria-label="Share on X">' +
        ...
        '</a>' +
        '<a class="share-btn share-btn--hatena" href="https://b.hatena.ne.jp/add?mode=confirm&url=' + pageUrl + '&title=' + pageTitle + '" target="_blank" rel="noopener" aria-label="Share on Hatena Bookmark">' +
